 ...
 */
public record UsersInfoDto(long id, String email, String name, String description, String iconUrl, String bannerUrl, long postCount, long followerCount, long followingCount) {
